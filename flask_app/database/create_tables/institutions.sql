...
`type`           varchar(100)  DEFAULT NULL                	COMMENT 'Organization Type; e.g. Academia, Industry, Government', 
...
`city`           varchar(100)  NOT NULL             	COMMENT 'The city of the institution.',
`state`          varchar(100)  NOT NULL              	COMMENT 'The state of the institution.',
